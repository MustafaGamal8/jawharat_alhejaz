        ...
        * ==========================================================================*/
        ...
        carousel_1i_get_src_multiple_margin: function() {
            ...
            $carousels.each( function() {
                ...
                $(this).owlCarousel({
                    ...
                    loop: carousel_loop,
                    autoHeight: true,
                    navText: ['<svg  xmlns="http://www.w3.org/2000/svg" width="60" height="14.776" viewBox="0 0 60 14.776">\n' +
                    ...
                    '  <g  transform="translate(20 -166.237)">\n' +
        ...
        stickySidebar: function() {
            setTimeout(function() {
                ...
                var marginTop = ($stickyHeader.length) ? ($stickyHeader.outerHeight() + 0) : 0; // check if there's sticky header
