            ...
            <div className="section-row flex-box  flex-box-4i flex-space-30" >
                ...
                <ul className="list-unstyled list-space-sm">
                  <li>
                    <div className="icon-text gap-2">
                      ...
                      <Link to="tel:+201121278844" dir='ltr'>+201121278844</Link>
                    </div>
                  </li>
                  <li>
                    <div className="icon-text gap-2">
              ...
              <div className="section-column">
                <ul className="list-unstyled list-space-sm" style={{ display: "flex", justifyContent: "space-between" }}>
                  <li>
                    <a href='#!' style={{ width: "32px", height: "32px", display: "flex", justifyContent: "center", alignItems: "center", backgroundColor: "#cc973a", padding: "4px", }}>
